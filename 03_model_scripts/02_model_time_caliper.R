...
# differs from model 1 by introducing a time dimension between sales in matching. 
#
...
###   C:  MATCHING
# ==============================================================================
# ---  Matching ATT + AI SE, and weights from the same pairs -------------------
# NOTE: Model 2 differs from Model 1 here (time-constrained matching).
...
### ADDED PART (to the baseline model) ###
